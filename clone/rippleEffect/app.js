...
class App {
    ...
    drawImage() {
        ...
        if (imgRatio > stageRatio) {
            ...
            this.imgPos.width = Math.round(
                this.image.width * (this.stageWidth / this.image.width)
            );

            this.imgPos.x = Math.round((this.stageHeight - this.imgPos.height) / 2);
        }
        ...
        this.tmpCtx.drawImage(this.image, 0, 0, this.image.width, this.image.height,
            this.imgPos.x, this.imgPos.y,
            this.imgPos.width, this.imgPos.height);
